                    ...
                    <div className="col-lg-8 mb-4">
                        <div className="card mb-5">
                            ...
                            <div className="card-body">
                                <h4 className="card-title">Qus-1: Difference between authorization and authentication</h4>
                        ...
                        <div className="card mb-5">
                            ...
                            <div className="card-body">
                                <h4 className="card-title">Qus-2: Why are you using firebase? What other options do you have to implement authentication?</h4>
                        ...
                        <div className="card mb-3">
                            ...
                            <div className="card-body">
                                <h4 className="card-title">Qus-3: What other services does firebase provide other than authentication?</h4>
